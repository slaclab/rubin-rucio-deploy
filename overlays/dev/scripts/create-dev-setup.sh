...
rucio-admin -a root scope add user.bjwhite
...
rucio-admin -a root scope add user.yuyi
...
rucio-admin -a root scope add user.daues
...
rucio-admin -a root scope add user.fabioh
...
rucio-admin -a root scope add user.abh
...
rucio-admin -a root scope add user.yangw
